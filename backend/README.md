...
└── src/
    ...
    │
    ├── middleware/
    │   └── auth.middleware.ts      # Optional JWT extraction & validation
    │
    ├── types/
...
- **Invalid token**: request continues as unauthenticated (middleware is non-blocking)
